...
<ul id="menu">
  ...
  <li><a href="[https://github.com/fidzongo/Kubernetes-cluster-avec-k3sup-k3s-Traefik/edit/main/README.md#installation-de-traefik-dashboard]">Installation de traefik dashboard</a></li>
</ul>
